...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($resultado->num_rows > 0) {
        ...
        $query->bind_param("sss", $nombre, $correo, $contrasena_encriptada);
        if ($query->execute()) {
            echo "<p style='text-align:center;color:green;'>Registro exitoso. Puedes iniciar sesión ahora.</p>";
        } else {
            echo "<p style='text-align:center;color:red;'>Error al registrar al usuario.</p>";
        }
    }
}
?>
